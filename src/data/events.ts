...
export const trailEvents: TrailEvent[] = [
  {
    slug: "campfire-mixer",
    title: "Campfire Mixer",
    company: "Ridgeline Collective",
    blurb: "An evening of introductions around the fire.",
    date: "March 14, 2026",
    location: "Ridgeline Basecamp",
    image: mixerImg,
    ...
    details: [
      { label: "Format", value: "Open mixer, drop-in" },
      { label: "Attendees", value: "40 hikers & makers" },
  ...
  },
  {
    ...
    title: "River Volunteer Day",
    company: "Cedar Creek Conservancy",
    blurb: "Clearing trails and planting along the creek.",
    date: "May 2, 2026",
    location: "Cedar Creek Trailhead",
    image: volunteerImg,
    ...
    details: [
      { label: "Format", value: "Hands-on volunteer day" },
      { label: "Attendees", value: "65 volunteers" },
  ...
  },
  {
    ...
    title: "Summit Sunrise Trek",
    company: "North Peak Outdoors",
    ...
    details: [
      { label: "Format", value: "Guided group trek" },
      { label: "Distance", value: "11 km, 900 m gain" },
